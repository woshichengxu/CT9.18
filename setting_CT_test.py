...
def parse_opts():
    ...
    parser.add_argument(
        '--img_list',
        default='./data_list/train_fold[i].txt' ,
        type=str,
    ...
    parser.add_argument(
        '--pretrain_path',
        default='C:/Users/abc/Desktop\MedicalNet_pytorch_files/pretrain/resnet_34_23dataset.pth',
        type=str,
        help=
    ...
    # 模型的保存路径，可修改
    args.save_folder = "./trails/34models/{}_{}".format(args.model, args.model_depth)
